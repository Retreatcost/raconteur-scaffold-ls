...
var watchify    = require('watchify'),
    ...
    lsify       = require('browserify-livescript'),
...
gulp.task('live', ['buildUndum'], bundle); // `gulp live` will generate bundle
...
gulp.task('build', ['html', 'img', 'less', 'live'], function () {
...
gulp.task('live-dist', ['undum-dist'], function () {
...
gulp.task('dist', ['html-dist', 'img-dist', 'less-dist', 'live-dist'],
  function () {
    return;
});
